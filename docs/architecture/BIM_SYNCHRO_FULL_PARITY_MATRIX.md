...
| H03 | Colaboracion cloud/CDE | Parcial | `BIM-TASK-0174` a `0178`: presencia/feed, concurrencia, metricas, recuperacion cliente y probe remoto sin secretos; falta ejecutar evidencia en servidor y red real |
