...
| H03 | Colaboracion cloud/CDE | Parcial | `BIM-TASK-0174/0175/0176`: presencia, feed incremental, concurrencia/reconexion PostgreSQL y metricas sanitizadas; falta evidencia en servidor y red real |
