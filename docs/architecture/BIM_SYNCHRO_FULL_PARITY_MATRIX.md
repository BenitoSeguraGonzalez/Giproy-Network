...
| H03 | Colaboracion cloud/CDE | Parcial | `BIM-TASK-0174` a `0180`: presencia/feed, concurrencia, metricas, recuperacion cliente, probe remoto, escala de 100.000 eventos y drenaje de rafagas; falta ejecutar evidencia en servidor y red real |
