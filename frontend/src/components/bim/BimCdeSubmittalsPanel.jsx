...
export default function BimCdeSubmittalsPanel({ projectId, empresaId, api = bimModelsApi }) {
    ...
    return <section className="bim-responsive-container border border-slate-200 bg-white" data-bim-cde-submittals>
        ...
        <div className="bim-responsive-two-column bim-responsive-cde-submittals min-h-[540px] text-xs">
