...
export default function BimCostSovPanel({ projectId, empresaId, api = bimModelsApi }) {
    ...
    return <section className="flex h-full min-h-0 flex-col overflow-hidden border border-zinc-200 bg-white" data-bim-cost-sov>
        ...
        <div className="grid min-h-0 flex-1 grid-cols-[520px_minmax(0,1fr)]">
