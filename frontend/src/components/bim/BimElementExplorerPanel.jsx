...
export default function BimElementExplorerPanel({ elements = [], onSelectElement, selectedElementId = null }) {
    ...
    return <section className="flex h-[min(34rem,calc(100vh-22rem))] min-h-[18rem] shrink-0 flex-col overflow-hidden border border-zinc-300 bg-white" data-bim-element-explorer>
