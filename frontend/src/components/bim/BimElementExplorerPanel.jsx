...
export default function BimElementExplorerPanel({ elements = [], onSelectElement, selectedElementId = null }) {
    ...
    return <section className="flex h-[min(18rem,calc(100vh-34rem))] min-h-[14rem] shrink-0 flex-col overflow-hidden border border-zinc-300 bg-white" data-bim-element-explorer>
