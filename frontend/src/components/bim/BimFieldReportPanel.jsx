...
const BimFieldReportPanel = ({ projectId, empresaId, api = bimModelsApi }) => {
    ...
    const [draft, setDraft] = useState({ activity: '', area: '', reportedAt: localNow(), progress: '', quantity: '', unit: 'm3', labor: '', equipment: '0', bac: '', pv: '', ac: '', currency: 'USD', log: '' });
