...
export default function BimFlowWorkspace({ project, access, onNavigateTarget, workspaceOverride = null, domainStateOverride = null }) {
  ...
  <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-2">
    ...
    {activeModelPanel === "versions" ? <BimVersionSelector models={effectiveWorkspace?.models || []} activeVersionId={activeVersionId || effectiveWorkspace?.active_version_id} onSelectVersion={setActiveVersionId} projectId={project?.id} empresaId={empresaId} onVersionsChanged={refresh} /> : null}
